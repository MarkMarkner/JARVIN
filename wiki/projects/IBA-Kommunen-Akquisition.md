---
type: project
title: IBA Kommunen-Akquisition — Systematische Kontaktierung aller 400 Kommunen
status: active
created: 2026-08-18
updated: 2026-08-18
tags:
  ...
  - kritisch
aliases:
  - Kommunen Akquisition
  - IBA Pilot-Kommunen
address: proj-iba-kommunen-001
---

# IBA Kommunen-Akquisition
## Projekt: Systematische Kontaktierung aller 400 Kommunen Deutschland

**Owner:** Mark Markner (Strategie & Oversight)  
**Vertrieb:** Externes Vertriebsteam (Ausführung)  
**Status:** 🟢 **GERADE GESTARTET** (2026-08-18)  
...
Systematische, bundesweite Kontaktierungskampagne aller deutschen Kommunen zur Akquisition von Pilot-Kunden für die Initiative Bau Archiv Plattform.

**Warum ist es kritisch?**
- Förder-Bewilligung hängt von 50TB Proof-of-Concept ab
- Proof-of-Concept = 200 Nutzer = 10-20 Kommunen nötig
- Timeline: Nur ~4-5 Monate bis Jahresende!
- Phase 0.2 (Critical Path Item)

**Differenzierung von Phase 0.2:**
- **Phase 0.2 (Projekt):** Allgemeines Ziel "200 Nutzer gewinnen"
- **Dieses Projekt:** SPEZIFISCHER Workflow für Kommunen-Kontaktierung
...
| Person/Team | Rolle | Aufwand | Kosten |
|------------|-------|--------|--------|
| **Mark Markner** | Strategie, Pitches, Oversight | ~50-80 Stunden | Bereits Gehalt |
| **Vertriebsteam (Ext.)** | Recherche, Outreach, Koordination | ~100-150 Stunden | Im Budget (250k/Jahr) |
| **Programmierer-Unternehmen** | Platform-Support, Optimierungen | ~30-50 Stunden | Im Budget |
| **Jurist (Ext.)** | Vertrag-Review, GmbH-Struktur | ~8-12 Stunden | ~2000-3000€ |
| **Onboarding-Team (Ext.)** | Schulungen, Datenmigration | ~40-60 Stunden | Im Budget |

### Tools & Kosten

| Tool | Funktion | Kosten | Status |
|------|----------|--------|--------|
| **Google Workspace** | Emails, Sheets, Drive | ~15€/Mo | ✅ Vorhanden |
| **Mailchimp / HubSpot** | Email-Kampagnen | ~15-50€/Mo | 🟡 Optional |
| **LinkedIn Sales Navigator** | Lead Research | ~65€/Mo | 🟡 Optional |
| **Pipedrive** | CRM + Pipeline | ~15/User/Mo | 🟡 Optional |

**Total Zusatzkosten:** ~100-200€/Mo (optional)
...
|--------|-------------------|--------|-----------|
| **Keine echten Kontakte finden** | 🟠 MEDIUM | 🔴 KRITISCH | Telefonverzeichnis + direkte Anrufe |
| **Sehr niedrige Response-Rate** | 🟠 MEDIUM | 🟠 HOCH | A/B-Tests + personalisierte Emails |
| **Zu wenig Zeit für alles** | 🔴 HOCH | 🔴 KRITISCH | Priorisieren: Top 50 zuerst, dann alle 400 |
| **Pilot-Kommunen geben Feedback zu spät** | 🟡 MITTEL | 🟠 HOCH | Regelmäßige Check-ins + schnelle Iteration |
| **Förder-Bewilligung zögert sich** | 🟡 MITTEL | 🔴 KRITISCH | Parallel andere Finanzierung erkunden |

### Fallback-Szenarien

**Fallback A: Zu wenig Pilot-Kommunen (< 5 by Oct 31)**
- Pivot zu Großkunden (Industrie statt Kommunen)
- Oder: Deadline verschieben (längere Pilotphase)

**Fallback B: Kontakte nicht zu finden**
- Zentrale anrufen (Vermittlung erfragen)
- LinkedIn Premium + intensive Recherche
- Oder: Höherrangige Stakeholder (Landrat statt Bauleiter)

**Fallback C: Response-Rate zu niedrig (< 2%)**
- Betreffzeile ändern (A/B Test)
- Persönlichere Ansprache (handgeschriebene Postkarten?)
- Oder: Video-Botschaft statt Standard-Email
...
```
🚀 PROJEKT START: 2026-08-18
📅 TARGET DEADLINE: 2026-12-31
🎯 ZIEL: 10-20 Pilot-Kommunen (50TB / 200 Nutzer)

AKTUELLER STATUS:
├─ Phase 1 (Datensammlung): 🟢 STARTING
├─ Phase 2 (Kontakt-Recherche): ⏳ PLANNED
├─ Phase 3 (Email-Kampagne): ⏳ PLANNED
├─ Phase 4 (Pitches & Verträge): ⏳ PLANNED
└─ Phase 5 (Pilotphase): ⏳ PLANNED

KRITISCHE PFADE:
1. Kontaktliste (Aug 24) ← MUSS KLAPPEN
2. 20+ Termine (Sep 15) ← MUSS KLAPPEN
3. 10-20 Verträge (Oct 31) ← MUSS KLAPPEN
4. 50TB aktiv (Dec 31) ← FÖRDER-BEWILLIGUNG ABHÄNGIG!
```

---

**Projekt Status:** 🟢 **GERADE GESTARTET**  
**Owner:** Mark Markner  
**Support:** Claude (Projekt-Management)  
**Letztes Update:** 2026-08-18

*"Die Kommunen-Akquisition ist der kritischste Pfad für Phase 0.2. Ohne diese erfolgt keine Förder-Bewilligung. Priorität: MAXIMAL!"*
